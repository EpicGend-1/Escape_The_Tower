...
function preload() {
  ...
  runAnime = loadAnimation("./assets/run1.png","./assets/run2.png","./assets/run3.png","/assets/run1.png")
  deadmonsterImg = loadImage("./assets/monstercondead5.png")
  monsterAnime = loadAnimation("./assets/monsterwalk1.png","./assets/monsterwalk2.png","./assets/monsterwalk3.png","./assets/monsterwalk4.png","./assets/monsterwalk1.png")
  monsterdyingAnime = loadAnimation("./assets/monsterdead1.png","./assets/monsterdead2.png","./assets/monsterdead3.png")
  towerImg = loadImage("./assets/tower.png")
  //sounds
  screamfnaf = loadSound("./assets/five-nights-at-freddys-full-scream-sound_2.mp3")
  bgtune = loadSound("./assets/Come-Play-with-Me.mp3")
  ...
  //floor3
  bonedoor3Img = loadImage("./assets/Doors/bonedoor3.png")
  dinodoor3Img = loadImage("./assets/Doors/dinodoor3.png")
  sadfacedoor3Img = loadImage("./assets/Doors/sadfacedoor3.png")
  //floor4
  aciddoor4Img = loadImage("./assets/Doors/aciddoor4.png")
  crocodiledoor4Img = loadImage("./assets/Doors/crocodiledoor4.png")
  electricdoor4Img = loadImage("./assets/Doors/electricdoor4.png")
  nonelectricdoor4Img = loadImage("./assets/Doors/nonelectricdoor4.png")
  wire4Img = loadImage("./assets/wire4.png")
  brokenwire4Img = loadImage("./assets/brokenwire4.png")
  pliers4Img = loadImage("./assets/pliers4.png")
  ladderImg = loadImage("./assets/ladder.png")
  //floor5
  prisondoorclosed5Img = loadImage("./assets/Doors/prisondoorclosed5.png")
  prisondooropened5Img = loadImage("./assets/Doors/prisondooropened5.png")
  werewolfdoor5Img = loadImage("./assets/Doors/werewolfdoor5.png")
  godoor5Img = loadImage("./assets/Doors/godoor5.png")
  axe5Img = loadImage("./assets/axe.png")
  window5Img = loadImage("./assets/window5.png")
  ropeImg = loadImage("./assets/rope.png")
  fanImg = loadImage("./assets/fan.png")
  ropecutterImg = loadImage("./assets/ropecutter.png")
  goldenkeyImg = loadImage("./assets/goldenkey.png")
  //gameInfoTexta
...
//animations
  ...
  werewolfdoor5.setCollider("rectangle",0,0,monsterbehinddoor1.width-150,monsterbehinddoor1.height);
...
//Gamestates
  ...
  if(mouseWentDown("leftButton") && mousePressedOver(playbutton)){
    ...
    if(gamestate === 5){
      ...
      crocodiledoor4.y = 485
      electricdoor4.y = 100
      aciddoor4.y = 485 
      ladder.y = 500
      electricdoorground.y = 300
      wire4.y = 20
      pliers4.y = 750
...
function monstermove(){
  if (gamestate === 6 && monster.y === 560 && axe5.x !== monster.x && axe5.y !== monster.y){
